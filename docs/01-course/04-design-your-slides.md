...
![YouTube player](https://i.ytimg.com/vi/wuIZHdM8H-Y/maxresdefault.jpg)

**What to expect:**

Discover how to cut your content into slides, select layouts, and choose a theme that will look great on any device.

**Reading time:** 2 minutes

---

In the previous tutorial you learned how to format your speaker notes, text, and visuals. With that done, let's have some fun choosing layouts and a theme.
...
![The Slides picker opened from the + button on left side of Editor.](https://ia.net/wp-content/uploads/2024/10/SlidesLayoutPickerbis.png)
...
![The Theme and Style menu, to open from the Inspector on the right.](https://ia.net/wp-content/uploads/2024/10/ThemeTabInspectorbis.png)
...
You can preview all our themes [right here](https://ia.net/presenter/support/visuals/in-app-themes).

Besides choosing a theme, you can also adjust every aspect like fonts and colors, and add extra elements like footers, headers, or logos. Discover all the possibilities [here](https://ia.net/presenter/support/visuals/design).
...
Original article: https://ia.net/presenter/how-to/design-your-slides

---

**Tags:** `slides`, `layout`, `theme`, `cells`, `responsive`, `design`, `slide-break`
